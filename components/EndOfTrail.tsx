    ...
    <section id="contact" aria-labelledby="eot-title" className="border-t border-[var(--color-inkline)] bg-[var(--color-parchment)] py-24">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="mt-8 flex flex-wrap gap-6">
          ...
          <a href="/field-log.pdf" download className="border border-[var(--color-ink)] px-5 py-3 font-[family-name:var(--font-data)] text-sm text-[var(--color-ink)] hover:shadow-[3px_3px_0_var(--color-inkline)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--color-rust)] focus-visible:outline-offset-2">Download the field log (PDF)</a>
        </div>
        <FieldNote />
        <div className="mt-14">
          <ContactFAQ />
